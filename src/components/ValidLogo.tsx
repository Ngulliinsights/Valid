...
export default function ValidLogo({
  ...
  const LEFT = `
    M 94 26
    C 66 52, 66 148, 94 174
    C 94 179, 87 182, 84 178
    C 34 152, 34 48, 84 22
    C 88 18, 94 22, 94 26
    Z
  `
  ...
  const RIGHT = `
    M 126 26
    C 154 52, 154 148, 126 174
    C 126 179, 133 182, 136 178
    C 186 152, 186 48, 136 22
    C 132 18, 126 22, 126 26
    Z
  `
